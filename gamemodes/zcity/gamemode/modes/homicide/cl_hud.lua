...
net.Receive("HMCD_UpdateTraitorAssistants", function()
    ...
    if LocalPlayer():Alive() then
        traitor_panel.visible = true--во вот ес чё
    end
end)
...
--окиро попросил убрать, хз но мне кажется это было зря
--игрокам пофек и т будут без раздумывания мочить и своих и не своих
