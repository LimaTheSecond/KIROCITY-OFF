...
function MODE:Intermission()
	...
	--самый крутой расчёт трейторов, на каждые 8 человек = +1 трейтор в тиму трейторов
	local traitors_needed = math.min(player_count - 1, math.max(1, math.floor(player_count / 8)))
